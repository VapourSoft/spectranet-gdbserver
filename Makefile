...
rsx-c-prl: build
	...
	rm -f rsx_body_template.bin rsx_body_real.bin src/rsx_cfunc.o src/pcw_rst8_c.o src/state.o erc/pcw_dart.o

	@echo "Compiling C object files"
	( cd src && zcc +cpm -compiler=sdcc -c rsx_cfunc.c -o rsx_cfunc.o ) || exit 1
	@if [ ! -f src/rsx_cfunc.o ]; then echo "ERROR: rsx_cfunc.o not produced"; exit 1; fi	

	@echo "Compiling C object files"
	( cd src && zcc +cpm  -compiler=sdcc -c pcw_dart.c -o pcw_dart.o ) || exit 1
	...
	( cd src && z80asm -b -DTEMPLATE rsx_body.asm  pcw_rst8.asm pcw_rst8_c.o state.o rsx_cfunc.o pcw_dart.o ) || exit 1
	...
	( cd src && z80asm -b rsx_body.asm pcw_rst8.asm pcw_rst8_c.o state.o rsx_cfunc.o pcw_dart.o ) || exit 1
