...
# need to fix this - order of objects and everthing MUST be the same - should be defined once!
	...
	( cd src && z80asm -b rsx_body.asm runtime.asm pcw_rst8.asm loader.asm pcw_dart_asm.asm pcw_rst8_c.o state.o rsx_cfunc.o pcw_dart.o server.o z80_decode.o -DTEMPLATE  ) || exit 1
	...
	( cd src && z80asm -b rsx_body.asm runtime.asm pcw_rst8.asm loader.asm pcw_dart_asm.asm pcw_rst8_c.o state.o rsx_cfunc.o pcw_dart.o server.o z80_decode.o  ) || exit 1
